...
SYSTEM_PROMPT = (
    ...
    "『売り』『ショート』『空売り』『利確売り』『利確』『全部利確』は SELL 寄りとして扱ってください。"
    "\n『エントリー』『指値』『〜でイン』『〜を超えたら』は entry に単一数値で設定。"
    "\n『ターゲット』『TP』が複数ある場合は targets に数値の配列で設定し、take には targets[0] を入れてください。"
    "例: ターゲット：3.93/4.15/4.63 → targets:[3.93,4.15,4.63], take:3.93"
    "\n『逆指値』『損切り』『SL』は stop に対応させてください。"
    "\n冒頭に '[TICKER のアラートへの返信]' とある場合、そのTICKERを銘柄として使ってください。"
    "返信ツイートで『利確』とあれば side=SELL、ない場合は信頼度に応じて判断してください。"
